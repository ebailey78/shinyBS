...
>>>>>>> d873e4df74fdc4e415c7195109cd32da03270598
              ...
              demoPanel(title = "Collapse",
                        ...
                        controls = tagList(checkboxInput("coMult", "Multiple"),
                                           ...
                                           tags$h5("Output"),
                                           textOutput("coValue")),
                        example = bsCollapse(multiple = FALSE, open = "col3", id = "collapse1",
